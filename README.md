...
- [RocketChat/docker-mmap-to-wiredtiger-migration](https://github.com/RocketChat/docker-mmap-to-wiredtiger-migration) -  (4 days ago)
...
- [frdmn/docker-rocketchat](https://github.com/frdmn/docker-rocketchat) - 🚢📦My `docker-compose.yml` file/setup to run Rocket.Chat in production (2 weeks ago)
